// Built-in icon library for the resource tracker.
...
export const ICON_LABELS: Record<IconId, string> = {
  gem: "宝石", heart: "心", starFour: "四角星", starFive: "五芒星",
  skull: "骷髅", hourglass: "沙漏", catEye: "猫眼石", gear: "齿轮",
  swords: "双剑", apple: "苹果", drumstick: "鸡腿", mask: "面具",
  cross: "十字架", axe: "斧头", shield: "盾牌", fist: "拳头",
  bow: "弓箭", note: "音符", lute: "琴", dagger: "匕首",
  lightning: "闪电", bloodDrop: "血滴", leaf: "树叶", waterDrop: "水滴",
  spellbook: "魔法书",
};
